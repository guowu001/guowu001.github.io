...
(function ($) {
    ...
    function go(els, opts, manual, fwd) {
        ...
        $('#describeul').find('li').removeClass("activeSlide").filter('#describe' + opts.currSlide).addClass("activeSlide");
    ...
    $.fn.cycle.defaults = {
        ...
        pager: "#bannerbtn",  // id of element to use as pager container 包含按扭的div；
        pagerClick: 4,  // callback fn for pager clicks:  function(zeroBasedSlideIndex, slideElement)控制显示的按扭个数；
